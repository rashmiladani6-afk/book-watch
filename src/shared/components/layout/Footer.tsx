    ...
    <footer className="bg-[#333338] text-gray-300 mt-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                Get the latest Garba events, mandal updates, passes, and exclusive offers.
              </p>
            </div>
            ...
            <div className="w-full md:w-auto flex-1 max-w-md">
              <form className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="shrink-0 px-6 py-2 text-white font-semibold rounded-md transition-colors hover:opacity-90"
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8 text-xs">
          <div>
            <h4 className="text-white font-semibold mb-3 text-sm">Garba Events</h4>
            <ul className="space-y-2">
              <li>
                <Link to={ROUTES.EVENTS_LIST} className="text-gray-300 hover:text-white transition-colors">
                  Events
                </Link>
              </li>
              <li>
                <Link to={ROUTES.PASSES} className="text-gray-300 hover:text-white transition-colors">
                  Passes
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={ROUTES.VENUES} className="text-gray-300 hover:text-white transition-colors">
                  Venues
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to={ROUTES.PROFILE} className="text-gray-300 hover:text-white transition-colors">
                  My Account
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to={getAuthUrl(ROUTES.HOME)} className="text-gray-300 hover:text-white transition-colors">
                  Login
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-300">24/7 Garba Support</span>
              </li>
            </ul>
          </div>
